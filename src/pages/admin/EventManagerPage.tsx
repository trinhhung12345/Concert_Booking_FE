    ...
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <Tabs defaultValue="all" className="w-full">
        <TabsList className="bg-muted border border-border text-muted-foreground">
          <TabsTrigger value="all" className="data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm">Tất cả ({events.length})</TabsTrigger>
