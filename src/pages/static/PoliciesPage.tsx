      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <div className="space-y-6">
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">1. Đăng ký và xác thực tổ chức</h2>
          ...
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">2. Tạo và quản lý sự kiện</h2>
          ...
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">3. Chính sách hoa hồng và thanh toán</h2>
          ...
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">4. Quy định về vé và giá vé</h2>
            <ul className="list-disc pl-5 space-y-1 text-slate-300 text-sm">
          ...
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">5. Trách nhiệm và hỗ trợ</h2>
            <p className="text-slate-300 text-sm leading-relaxed">
          ...
          <section className="bg-gray-800/70 border border-slate-700 rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-white mb-2">6. Chấm dứt hợp tác</h2>
            <p className="text-slate-300 text-sm leading-relaxed">
