      ...
      <div className="container mx-auto px-4 py-10 max-w-4xl">
        ...
        <div className="space-y-6">
          <section className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-foreground mb-2">1. Phạm vi áp dụng</h2>
          ...
          <section className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-foreground mb-2">2. Tài khoản và bảo mật</h2>
          ...
          <section className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-foreground mb-2">3. Hành vi bị cấm</h2>
          ...
          <section className="bg-card border border-border rounded-2xl p-6 shadow-sm">
            <h2 className="text-lg font-semibold text-foreground mb-2">4. Thay đổi điều khoản</h2>
            <p className="text-muted-foreground text-sm leading-relaxed">
